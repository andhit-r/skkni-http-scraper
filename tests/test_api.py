...
def test_search_documents_fresh_then_cache(client: TestClient, mock_repo):
    ...
    r1 = client.get("/skkni/search-documents", params={"page_from": 1, "page_to": 1, "limit": 5, "force_refresh": True})
...
def test_taxonomy_browsing(client: TestClient, mock_repo):
    ...
    client.get("/skkni/search-documents", params={"page_from": 1, "page_to": 1, "limit": 5, "force_refresh": True})
...
def test_search_units_with_q_and_filters(client: TestClient, mock_repo):
    # warm cache
    client.get("/skkni/search-units", params={"page_from": 1, "page_to": 1, "limit": 10, "force_refresh": True})
